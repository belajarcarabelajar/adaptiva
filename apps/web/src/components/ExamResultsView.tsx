          ...
          >
            ...
            <div className="mt-2 md:mt-3">
              <DetailedExplanation
                  ...
                  onLoadDetailedExplanation={() => onLoadDetailedExplanation(q.id)}
                  accordionKeyPrefix="detail-accordion-exam"
                  titleText="Further Details:"
                  loadingTextSize="text-sm md:text-md"
                  accordionTitleSize="text-md md:text-lg"
                  markdownTextSize="text-sm md:text-base"
                  regenerateButtonSize="text-xs"
                  loadMoreButtonSize="text-xs md:text-sm"
              />
            </div>
          </Accordion>
        ))}
