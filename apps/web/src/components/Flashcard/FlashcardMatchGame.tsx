...
const FlashcardMatchGame: React.FC<FlashcardMatchGameProps> = ({
  ...
  return (
    <div className="mt-4 p-4 md:p-6 bg-brand-lightGray/30 dark:bg-gray-800/30 rounded-lg border border-brand-mediumGray dark:border-gray-700 min-h-[300px]">
        {!matchGameActive && !gameIsCompleted && (
         ...
         {error && <p className={`my-2 text-brand-red dark:text-red-400 text-center`}>{error}</p>}
